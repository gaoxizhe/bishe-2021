package com.ms.utils.generator;
...
public class MybatisCodeGenerator {
    ...
    private static final String schemaName = "upms_dev";   // 数据库名称，必填
    private static final String[][] tables = {{"t_system_param", "SystemParam"}};   // 表名，实体名 必填

    static {
        // 必填
        ds.setUrl("jdbc:mysql://8.134.59.47:3306/" + schemaName + "?useUnicode=true&characterEncoding=utf-8&allowMultiQueries=true&useSSL=false&serverTimezone=GMT%2b8");
        ds.setUsername("upms_dev");
        ds.setPassword("Password@2021");
    }

    private static final String BaseFilePath = System.getProperty("user.dir") + "/src/main/java/com/ms/";
    private static final String basePackageName = "com.ms";
    ...
    static void createEntity(String tableName, String entityName) throws SQLException {
        ...
        StringBuilder entityBodyBuild = StrUtil.builder()
                ...
                .append(space4).append("private String id;\n\n");
    ...
    static void createMapper(String entityName) {
        StringBuilder build = StrUtil.builder().append("package com.ms.mapper;\n\n")
                .append("import com.ms.entity.").append(entityName).append(";\n")
    ...
    static void createService(String entityName) {
        ...
        StringBuilder build = StrUtil.builder().append("package com.ms.service;\n\n")
                .append("import com.ms.entity.").append(entityName).append(";\n")
                .append("import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;\n")
                .append("import com.ms.mapper.").append(entityName).append("Mapper;\n")
    ...
    static void createController(String entityName) {
        ...
        StringBuilder build = StrUtil.builder().append("package com.ms.controller;\n\n")
                .append("import com.ms.common.Result;\n")
                .append("import com.ms.entity.").append(entityName).append(";\n")
                .append("import com.ms.service.").append(serviceUpperName).append(";\n")
    ...
    static void createXml(String entityName) {
        String str = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                ...
                "<mapper namespace=\"com.ms.mapper." + entityName + "Mapper\">\n\n" +
                "</mapper>";
