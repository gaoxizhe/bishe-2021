$(function () {
    ...
    initialCookie();
    initialData();
    new snowflakeCursor({ element: document.querySelector("#div_background") })
...
function initialCookie() {
    ...
    $("#div_background").css("background-image", "url(/mall/static/images/admin/loginPage/background.jpg)");
}
